...
# Repo root: parent of libpi/ (set by main Makefile, or default to parent of this file)
CS140E_2026_PATH ?= $(abspath $(dir $(lastword $(MAKEFILE_LIST)))/..)
...
LPI ?= $(LPP)/libpi.a
# Use toolchain libgcc (no external lib/ required)
LGCC ?= $(shell $(ARM)-gcc -print-libgcc-file-name)
